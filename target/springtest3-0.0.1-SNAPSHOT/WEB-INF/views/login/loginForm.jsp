  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .form-group input {
      ...
      border-radius: 4px; font-size: 1em; outline: none;
    }
    ...
    /* ─── 버튼/링크 버튼 ─── */
    .text-btn {
      display: block;                /* a 태그에도 버튼처럼 보이도록 */
      width: 100%;
      padding: 12px 0;
...
<div class="container">
  <div class="login-box">
    ...
    <form action="<c:url value='/login'/>" method="post">
      ...
      <!-- ⬇️ 추가된 구간: 안내 문구 + 회원가입 버튼(링크) -->
      <div style="display:flex;align-items:center;justify-content:space-between;margin:6px 0 12px;flex-wrap:nowrap;">
        <span style="color:#666;font-size:0.95em;">계정이 없으신가요?</span>
        <a href="${pageContext.request.contextPath}/register"
           style="color:var(--primary);text-decoration:underline;text-underline-offset:2px;font-weight:500;white-space:nowrap;">
          회원가입
        </a>
      </div>
