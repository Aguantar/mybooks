    ...
    <div class="auth-body">
      ...
      <form action="${pageContext.request.contextPath}/register"
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;margin:6px 0 12px;flex-wrap:nowrap;">
          <span style="color:#666;font-size:0.95rem;">계정이 있으신가요?</span>
          <a href="${pageContext.request.contextPath}/loginForm"
             style="color:var(--primary);text-decoration:underline;text-underline-offset:2px;font-weight:600;white-space:nowrap;padding:4px 6px;">
            로그인
          </a>
        </div>
        <!-- ⬆️ 추가 끝 -->
